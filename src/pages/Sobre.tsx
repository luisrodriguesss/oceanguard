...
const architecture = [
  ...
  { layer: 'Front-end',   tech: 'React + Vite', desc: 'Dashboard e visualização cartográfica', color: 'bg-ocean-400' },
]
    ...
    <div className="text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold mb-6">
              ...
              <span className="block text-ocean-400">dos oceanos</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-bold mb-4">
              Arquitetura <span className="text-ocean-400">técnica</span>
            </h2>
          ...
          <div className="flex flex-col md:flex-row items-stretch gap-4">
            {architecture.map((item, index) => (
              <div key={item.layer} className="flex-1 flex flex-col">
                <div className="bg-navy-800 border border-navy-700 rounded-2xl p-5 flex-1">
                  ...
                  <p className="text-lg font-bold text-white mb-2">{item.tech}</p>
                  <p className="text-sm text-gray-400">{item.desc}</p>
                </div>
                {index < architecture.length - 1 && (
                  <div className="hidden md:flex items-center justify-center py-2 text-navy-600">
      ...
      <section className="py-20 bg-navy-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="text-3xl font-bold mb-4">
              Regras de <span className="text-ocean-400">detecção</span>
            </h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={rn.code} className="bg-navy-800 border border-navy-700 rounded-xl p-5">
                <span className="text-xs font-mono text-ocean-400 bg-ocean-400/10 px-2 py-1 rounded mb-3 inline-block">
                  {rn.code}
                </span>
                <h4 className="font-semibold text-white mb-2">{rn.title}</h4>
                <p className="text-sm text-gray-400 leading-relaxed">{rn.desc}</p>
              </div>
            ))}
          </div>
        </div>
